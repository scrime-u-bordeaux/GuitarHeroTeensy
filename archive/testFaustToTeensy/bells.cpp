...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = std::tan((20420.3516f / fConst0));
		...
		fConst15 = std::pow(0.00100000005f, (0.049147319f / fConst0));
		fConst16 = (std::cos((1630.04053f / fConst0)) * (0.0f - (2.0f * fConst15)));
		fConst17 = mydsp_faustpower2_f(fConst15);
		fConst18 = std::pow(0.00100000005f, (0.0493383184f / fConst0));
		fConst19 = (std::cos((1645.28345f / fConst0)) * (0.0f - (2.0f * fConst18)));
		fConst20 = mydsp_faustpower2_f(fConst18);
		fConst21 = std::pow(0.00100000005f, (0.0732557774f / fConst0));
		fConst22 = (std::cos((3099.69019f / fConst0)) * (0.0f - (2.0f * fConst21)));
		fConst23 = mydsp_faustpower2_f(fConst21);
		fConst24 = std::pow(0.00100000005f, (0.0734085441f / fConst0));
		fConst25 = (std::cos((3106.85913f / fConst0)) * (0.0f - (2.0f * fConst24)));
		fConst26 = mydsp_faustpower2_f(fConst24);
		fConst27 = std::pow(0.00100000005f, (0.0901254416f / fConst0));
		fConst28 = (std::cos((3789.06226f / fConst0)) * (0.0f - (2.0f * fConst27)));
		fConst29 = mydsp_faustpower2_f(fConst27);
		fConst30 = std::pow(0.00100000005f, (0.0904246792f / fConst0));
		fConst31 = (std::cos((3799.70605f / fConst0)) * (0.0f - (2.0f * fConst30)));
		fConst32 = mydsp_faustpower2_f(fConst30);
		fConst33 = std::pow(0.00100000005f, (0.115445048f / fConst0));
		fConst34 = (std::cos((4552.58252f / fConst0)) * (0.0f - (2.0f * fConst33)));
		fConst35 = mydsp_faustpower2_f(fConst33);
		fConst36 = std::pow(0.00100000005f, (0.115496799f / fConst0));
		fConst37 = (std::cos((4553.9082f / fConst0)) * (0.0f - (2.0f * fConst36)));
		fConst38 = mydsp_faustpower2_f(fConst36);
		fConst39 = std::pow(0.00100000005f, (0.13220939f / fConst0));
		fConst40 = (std::cos((4944.77246f / fConst0)) * (0.0f - (2.0f * fConst39)));
		fConst41 = mydsp_faustpower2_f(fConst39);
		fConst42 = std::pow(0.00100000005f, (0.185864583f / fConst0));
		fConst43 = (std::cos((5855.25635f / fConst0)) * (0.0f - (2.0f * fConst42)));
		fConst44 = mydsp_faustpower2_f(fConst42);
		fConst45 = std::pow(0.00100000005f, (0.0586840585f / fConst0));
		fConst46 = (std::cos((2758.80225f / fConst0)) * (0.0f - (2.0f * fConst45)));
		fConst47 = mydsp_faustpower2_f(fConst45);
		fConst48 = std::pow(0.00100000005f, (0.0587863363f / fConst0));
		fConst49 = (std::cos((2766.51782f / fConst0)) * (0.0f - (2.0f * fConst48)));
		fConst50 = mydsp_faustpower2_f(fConst48);
		fConst51 = std::pow(0.00100000005f, (0.0751398876f / fConst0));
		fConst52 = (std::cos((3810.4502f / fConst0)) * (0.0f - (2.0f * fConst51)));
		fConst53 = mydsp_faustpower2_f(fConst51);
		fConst54 = std::pow(0.00100000005f, (0.075759083f / fConst0));
		fConst55 = (std::cos((3843.90186f / fConst0)) * (0.0f - (2.0f * fConst54)));
		fConst56 = mydsp_faustpower2_f(fConst54);
		fConst57 = std::pow(0.00100000005f, (0.088457182f / fConst0));
		fConst58 = (std::cos((4458.65527f / fConst0)) * (0.0f - (2.0f * fConst57)));
		fConst59 = mydsp_faustpower2_f(fConst57);
		fConst60 = std::pow(0.00100000005f, (0.0884945765f / fConst0));
		fConst61 = (std::cos((4460.28857f / fConst0)) * (0.0f - (2.0f * fConst60)));
		fConst62 = mydsp_faustpower2_f(fConst60);
		fConst63 = std::pow(0.00100000005f, (0.113536403f / fConst0));
		fConst64 = (std::cos((5384.47607f / fConst0)) * (0.0f - (2.0f * fConst63)));
		fConst65 = mydsp_faustpower2_f(fConst63);
		fConst66 = std::pow(0.00100000005f, (0.122413002f / fConst0));
		fConst67 = (std::cos((5648.90381f / fConst0)) * (0.0f - (2.0f * fConst66)));
		fConst68 = mydsp_faustpower2_f(fConst66);
		fConst69 = std::pow(0.00100000005f, (0.16781573f / fConst0));
		fConst70 = (std::cos((6687.63379f / fConst0)) * (0.0f - (2.0f * fConst69)));
		fConst71 = mydsp_faustpower2_f(fConst69);
		fConst72 = std::pow(0.00100000005f, (0.167944118f / fConst0));
		fConst73 = (std::cos((6690.02148f / fConst0)) * (0.0f - (2.0f * fConst72)));
		fConst74 = mydsp_faustpower2_f(fConst72);
		fConst75 = std::pow(0.00100000005f, (0.0456838682f / fConst0));
		fConst76 = (std::cos((1501.1095f / fConst0)) * (0.0f - (2.0f * fConst75)));
		fConst77 = mydsp_faustpower2_f(fConst75);
		fConst78 = std::pow(0.00100000005f, (0.045769155f / fConst0));
		fConst79 = (std::cos((1509.44104f / fConst0)) * (0.0f - (2.0f * fConst78)));
		fConst80 = mydsp_faustpower2_f(fConst78);
		fConst81 = std::pow(0.00100000005f, (0.058489956f / fConst0));
		fConst82 = (std::cos((2552.54395f / fConst0)) * (0.0f - (2.0f * fConst81)));
		fConst83 = mydsp_faustpower2_f(fConst81);
		fConst84 = std::pow(0.00100000005f, (0.0586686358f / fConst0));
		fConst85 = (std::cos((2564.88428f / fConst0)) * (0.0f - (2.0f * fConst84)));
		fConst86 = mydsp_faustpower2_f(fConst84);
		fConst87 = std::pow(0.00100000005f, (0.0753062144f / fConst0));
		fConst88 = (std::cos((3525.52661f / fConst0)) * (0.0f - (2.0f * fConst87)));
		fConst89 = mydsp_faustpower2_f(fConst87);
		fConst90 = std::pow(0.00100000005f, (0.0755418241f / fConst0));
		fConst91 = (std::cos((3536.94946f / fConst0)) * (0.0f - (2.0f * fConst90)));
		fConst92 = mydsp_faustpower2_f(fConst90);
		fConst93 = std::pow(0.00100000005f, (0.106513768f / fConst0));
		fConst94 = (std::cos((4710.07666f / fConst0)) * (0.0f - (2.0f * fConst93)));
		fConst95 = mydsp_faustpower2_f(fConst93);
		fConst96 = std::pow(0.00100000005f, (0.106565893f / fConst0));
		fConst97 = (std::cos((4711.63477f / fConst0)) * (0.0f - (2.0f * fConst96)));
		fConst98 = mydsp_faustpower2_f(fConst96);
		fConst99 = std::pow(0.00100000005f, (0.1134905f / fConst0));
		fConst100 = (std::cos((4909.61182f / fConst0)) * (0.0f - (2.0f * fConst99)));
		fConst101 = mydsp_faustpower2_f(fConst99);
		fConst102 = std::pow(0.00100000005f, (0.118044332f / fConst0));
		fConst103 = (std::cos((5030.8208f / fConst0)) * (0.0f - (2.0f * fConst102)));
		fConst104 = mydsp_faustpower2_f(fConst102);
		fConst105 = std::pow(0.00100000005f, (0.0478694402f / fConst0));
		fConst106 = (std::cos((857.598267f / fConst0)) * (0.0f - (2.0f * fConst105)));
		fConst107 = mydsp_faustpower2_f(fConst105);
		fConst108 = std::pow(0.00100000005f, (0.0479370914f / fConst0));
		fConst109 = (std::cos((860.746094f / fConst0)) * (0.0f - (2.0f * fConst108)));
		fConst110 = mydsp_faustpower2_f(fConst108);
		fConst111 = std::pow(0.00100000005f, (0.0690707192f / fConst0));
		fConst112 = (std::cos((1627.08105f / fConst0)) * (0.0f - (2.0f * fConst111)));
		fConst113 = mydsp_faustpower2_f(fConst111);
		fConst114 = std::pow(0.00100000005f, (0.069393076f / fConst0));
		fConst115 = (std::cos((1636.26086f / fConst0)) * (0.0f - (2.0f * fConst114)));
		fConst116 = mydsp_faustpower2_f(fConst114);
		fConst117 = std::pow(0.00100000005f, (0.0834438205f / fConst0));
		fConst118 = (std::cos((1988.55908f / fConst0)) * (0.0f - (2.0f * fConst117)));
		fConst119 = mydsp_faustpower2_f(fConst117);
		fConst120 = std::pow(0.00100000005f, (0.0839901417f / fConst0));
		fConst121 = (std::cos((2000.63538f / fConst0)) * (0.0f - (2.0f * fConst120)));
		fConst122 = mydsp_faustpower2_f(fConst120);
		fConst123 = std::pow(0.00100000005f, (0.10981027f / fConst0));
		fConst124 = (std::cos((2474.64502f / fConst0)) * (0.0f - (2.0f * fConst123)));
		fConst125 = mydsp_faustpower2_f(fConst123);
		fConst126 = std::pow(0.00100000005f, (0.109849863f / fConst0));
		fConst127 = (std::cos((2475.25464f / fConst0)) * (0.0f - (2.0f * fConst126)));
		fConst128 = mydsp_faustpower2_f(fConst126);
		fConst129 = std::pow(0.00100000005f, (0.138905898f / fConst0));
		fConst130 = (std::cos((2856.81982f / fConst0)) * (0.0f - (2.0f * fConst129)));
		fConst131 = mydsp_faustpower2_f(fConst129);
		fConst132 = std::pow(0.00100000005f, (0.14631474f / fConst0));
		fConst133 = (std::cos((2937.34521f / fConst0)) * (0.0f - (2.0f * fConst132)));
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("kb0k0status", &fHslider0, 0.0f, 0.0f, 1.0f, 1.0f);
		...
		ui_interface->addHorizontalSlider("x", &fHslider1, 1.0f, 0.0f, 1.0f, 0.00100000005f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		int iSlow0 = int(std::min<float>(1.0f, float(fHslider0)));
		int iSlow1 = (10 * int((6.0f * std::min<float>(std::fabs(((2.0f * float(fHslider1)) + -1.0f)), std::fabs(((2.0f * float(fHslider2)) + -1.0f))))));
		float fSlow2 = ftbl0mydspSIG0[iSlow1];
		int iSlow3 = (iSlow1 + 1);
		float fSlow4 = ftbl0mydspSIG0[iSlow3];
		int iSlow5 = (iSlow1 + 2);
		float fSlow6 = ftbl0mydspSIG0[iSlow5];
		int iSlow7 = (iSlow1 + 3);
		float fSlow8 = ftbl0mydspSIG0[iSlow7];
		int iSlow9 = (iSlow1 + 4);
		float fSlow10 = ftbl0mydspSIG0[iSlow9];
		int iSlow11 = (iSlow1 + 5);
		float fSlow12 = ftbl0mydspSIG0[iSlow11];
		int iSlow13 = (iSlow1 + 6);
		float fSlow14 = ftbl0mydspSIG0[iSlow13];
		int iSlow15 = (iSlow1 + 7);
		float fSlow16 = ftbl0mydspSIG0[iSlow15];
		int iSlow17 = (iSlow1 + 8);
		float fSlow18 = ftbl0mydspSIG0[iSlow17];
		int iSlow19 = (iSlow1 + 9);
		float fSlow20 = ftbl0mydspSIG0[iSlow19];
		int iSlow21 = int(std::min<float>(1.0f, float(fHslider3)));
		float fSlow22 = ftbl1mydspSIG1[iSlow1];
		float fSlow23 = ftbl1mydspSIG1[iSlow3];
		float fSlow24 = ftbl1mydspSIG1[iSlow5];
		float fSlow25 = ftbl1mydspSIG1[iSlow7];
		float fSlow26 = ftbl1mydspSIG1[iSlow9];
		float fSlow27 = ftbl1mydspSIG1[iSlow11];
		float fSlow28 = ftbl1mydspSIG1[iSlow13];
		float fSlow29 = ftbl1mydspSIG1[iSlow15];
		float fSlow30 = ftbl1mydspSIG1[iSlow17];
		float fSlow31 = ftbl1mydspSIG1[iSlow19];
		int iSlow32 = int(std::min<float>(1.0f, float(fHslider4)));
		float fSlow33 = ftbl2mydspSIG2[iSlow1];
		float fSlow34 = ftbl2mydspSIG2[iSlow3];
		float fSlow35 = ftbl2mydspSIG2[iSlow5];
		float fSlow36 = ftbl2mydspSIG2[iSlow7];
		float fSlow37 = ftbl2mydspSIG2[iSlow9];
		float fSlow38 = ftbl2mydspSIG2[iSlow11];
		float fSlow39 = ftbl2mydspSIG2[iSlow13];
		float fSlow40 = ftbl2mydspSIG2[iSlow15];
		float fSlow41 = ftbl2mydspSIG2[iSlow17];
		float fSlow42 = ftbl2mydspSIG2[iSlow19];
		int iSlow43 = int(std::min<float>(1.0f, float(fHslider5)));
		float fSlow44 = ftbl3mydspSIG3[iSlow1];
		float fSlow45 = ftbl3mydspSIG3[iSlow3];
		float fSlow46 = ftbl3mydspSIG3[iSlow5];
		float fSlow47 = ftbl3mydspSIG3[iSlow7];
		float fSlow48 = ftbl3mydspSIG3[iSlow9];
		float fSlow49 = ftbl3mydspSIG3[iSlow11];
		float fSlow50 = ftbl3mydspSIG3[iSlow13];
		float fSlow51 = ftbl3mydspSIG3[iSlow15];
		float fSlow52 = ftbl3mydspSIG3[iSlow17];
		float fSlow53 = ftbl3mydspSIG3[iSlow19];
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			iVec0[0] = iSlow0;
			iRec4[0] = (((iRec4[1] + (iRec4[1] > 0)) * (iSlow0 <= iVec0[1])) + (iSlow0 > iVec0[1]));
			float fTemp1 = (fConst14 * float(iRec4[0]));
			float fTemp2 = (fConst3 * (fTemp0 * std::max<float>(0.0f, std::min<float>(fTemp1, (2.0f - fTemp1)))));
			fRec0[0] = (fTemp2 - ((fConst16 * fRec0[1]) + (fConst17 * fRec0[2])));
			fRec5[0] = (fTemp2 - ((fConst19 * fRec5[1]) + (fConst20 * fRec5[2])));
			fRec6[0] = (fTemp2 - ((fConst22 * fRec6[1]) + (fConst23 * fRec6[2])));
			fRec7[0] = (fTemp2 - ((fConst25 * fRec7[1]) + (fConst26 * fRec7[2])));
			fRec8[0] = (fTemp2 - ((fConst28 * fRec8[1]) + (fConst29 * fRec8[2])));
			fRec9[0] = (fTemp2 - ((fConst31 * fRec9[1]) + (fConst32 * fRec9[2])));
			fRec10[0] = (fTemp2 - ((fConst34 * fRec10[1]) + (fConst35 * fRec10[2])));
			fRec11[0] = (fTemp2 - ((fConst37 * fRec11[1]) + (fConst38 * fRec11[2])));
			fRec12[0] = (fTemp2 - ((fConst40 * fRec12[1]) + (fConst41 * fRec12[2])));
			fRec13[0] = (fTemp2 - ((fConst43 * fRec13[1]) + (fConst44 * fRec13[2])));
			iVec1[0] = iSlow21;
			iRec15[0] = (((iRec15[1] + (iRec15[1] > 0)) * (iSlow21 <= iVec1[1])) + (iSlow21 > iVec1[1]));
			float fTemp3 = (fConst14 * float(iRec15[0]));
			float fTemp4 = (fConst3 * (fTemp0 * std::max<float>(0.0f, std::min<float>(fTemp3, (2.0f - fTemp3)))));
			fRec14[0] = (fTemp4 - ((fConst46 * fRec14[1]) + (fConst47 * fRec14[2])));
			fRec16[0] = (fTemp4 - ((fConst49 * fRec16[1]) + (fConst50 * fRec16[2])));
			fRec17[0] = (fTemp4 - ((fConst52 * fRec17[1]) + (fConst53 * fRec17[2])));
			fRec18[0] = (fTemp4 - ((fConst55 * fRec18[1]) + (fConst56 * fRec18[2])));
			fRec19[0] = (fTemp4 - ((fConst58 * fRec19[1]) + (fConst59 * fRec19[2])));
			fRec20[0] = (fTemp4 - ((fConst61 * fRec20[1]) + (fConst62 * fRec20[2])));
			fRec21[0] = (fTemp4 - ((fConst64 * fRec21[1]) + (fConst65 * fRec21[2])));
			fRec22[0] = (fTemp4 - ((fConst67 * fRec22[1]) + (fConst68 * fRec22[2])));
			fRec23[0] = (fTemp4 - ((fConst70 * fRec23[1]) + (fConst71 * fRec23[2])));
			fRec24[0] = (fTemp4 - ((fConst73 * fRec24[1]) + (fConst74 * fRec24[2])));
			iVec2[0] = iSlow32;
			iRec26[0] = (((iRec26[1] + (iRec26[1] > 0)) * (iSlow32 <= iVec2[1])) + (iSlow32 > iVec2[1]));
			float fTemp5 = (fConst14 * float(iRec26[0]));
			float fTemp6 = (fConst3 * (fTemp0 * std::max<float>(0.0f, std::min<float>(fTemp5, (2.0f - fTemp5)))));
			fRec25[0] = (fTemp6 - ((fConst76 * fRec25[1]) + (fConst77 * fRec25[2])));
			fRec27[0] = (fTemp6 - ((fConst79 * fRec27[1]) + (fConst80 * fRec27[2])));
			fRec28[0] = (fTemp6 - ((fConst82 * fRec28[1]) + (fConst83 * fRec28[2])));
			fRec29[0] = (fTemp6 - ((fConst85 * fRec29[1]) + (fConst86 * fRec29[2])));
			fRec30[0] = (fTemp6 - ((fConst88 * fRec30[1]) + (fConst89 * fRec30[2])));
			fRec31[0] = (fTemp6 - ((fConst91 * fRec31[1]) + (fConst92 * fRec31[2])));
			fRec32[0] = (fTemp6 - ((fConst94 * fRec32[1]) + (fConst95 * fRec32[2])));
			fRec33[0] = (fTemp6 - ((fConst97 * fRec33[1]) + (fConst98 * fRec33[2])));
			fRec34[0] = (fTemp6 - ((fConst100 * fRec34[1]) + (fConst101 * fRec34[2])));
			fRec35[0] = (fTemp6 - ((fConst103 * fRec35[1]) + (fConst104 * fRec35[2])));
			iVec3[0] = iSlow43;
			iRec37[0] = (((iRec37[1] + (iRec37[1] > 0)) * (iSlow43 <= iVec3[1])) + (iSlow43 > iVec3[1]));
			float fTemp7 = (fConst14 * float(iRec37[0]));
			float fTemp8 = (fConst3 * (fTemp0 * std::max<float>(0.0f, std::min<float>(fTemp7, (2.0f - fTemp7)))));
			fRec36[0] = (fTemp8 - ((fConst106 * fRec36[1]) + (fConst107 * fRec36[2])));
			fRec38[0] = (fTemp8 - ((fConst109 * fRec38[1]) + (fConst110 * fRec38[2])));
			fRec39[0] = (fTemp8 - ((fConst112 * fRec39[1]) + (fConst113 * fRec39[2])));
			fRec40[0] = (fTemp8 - ((fConst115 * fRec40[1]) + (fConst116 * fRec40[2])));
			fRec41[0] = (fTemp8 - ((fConst118 * fRec41[1]) + (fConst119 * fRec41[2])));
			fRec42[0] = (fTemp8 - ((fConst121 * fRec42[1]) + (fConst122 * fRec42[2])));
			fRec43[0] = (fTemp8 - ((fConst124 * fRec43[1]) + (fConst125 * fRec43[2])));
			fRec44[0] = (fTemp8 - ((fConst127 * fRec44[1]) + (fConst128 * fRec44[2])));
			fRec45[0] = (fTemp8 - ((fConst130 * fRec45[1]) + (fConst131 * fRec45[2])));
			fRec46[0] = (fTemp8 - ((fConst133 * fRec46[1]) + (fConst134 * fRec46[2])));
			float fTemp9 = (0.0199999996f * ((((((((((((((fRec0[0] - fRec0[2]) * fSlow2) + ((fRec5[0] - fRec5[2]) * fSlow4)) + ((fRec6[0] - fRec6[2]) * fSlow6)) + ((fRec7[0] - fRec7[2]) * fSlow8)) + ((fRec8[0] - fRec8[2]) * fSlow10)) + ((fRec9[0] - fRec9[2]) * fSlow12)) + ((fRec10[0] - fRec10[2]) * fSlow14)) + ((fRec11[0] - fRec11[2]) * fSlow16)) + ((fRec12[0] - fRec12[2]) * fSlow18)) + ((fRec13[0] - fRec13[2]) * fSlow20)) + (((((((((((fRec14[0] - fRec14[2]) * fSlow22) + ((fRec16[0] - fRec16[2]) * fSlow23)) + ((fRec17[0] - fRec17[2]) * fSlow24)) + ((fRec18[0] - fRec18[2]) * fSlow25)) + ((fRec19[0] - fRec19[2]) * fSlow26)) + ((fRec20[0] - fRec20[2]) * fSlow27)) + ((fRec21[0] - fRec21[2]) * fSlow28)) + ((fRec22[0] - fRec22[2]) * fSlow29)) + ((fRec23[0] - fRec23[2]) * fSlow30)) + ((fRec24[0] - fRec24[2]) * fSlow31))) + (((((((((((fRec25[0] - fRec25[2]) * fSlow33) + ((fRec27[0] - fRec27[2]) * fSlow34)) + ((fRec28[0] - fRec28[2]) * fSlow35)) + ((fRec29[0] - fRec29[2]) * fSlow36)) + ((fRec30[0] - fRec30[2]) * fSlow37)) + ((fRec31[0] - fRec31[2]) * fSlow38)) + ((fRec32[0] - fRec32[2]) * fSlow39)) + ((fRec33[0] - fRec33[2]) * fSlow40)) + ((fRec34[0] - fRec34[2]) * fSlow41)) + ((fRec35[0] - fRec35[2]) * fSlow42))) + (((((((((((fRec36[0] - fRec36[2]) * fSlow44) + ((fRec38[0] - fRec38[2]) * fSlow45)) + ((fRec39[0] - fRec39[2]) * fSlow46)) + ((fRec40[0] - fRec40[2]) * fSlow47)) + ((fRec41[0] - fRec41[2]) * fSlow48)) + ((fRec42[0] - fRec42[2]) * fSlow49)) + ((fRec43[0] - fRec43[2]) * fSlow50)) + ((fRec44[0] - fRec44[2]) * fSlow51)) + ((fRec45[0] - fRec45[2]) * fSlow52)) + ((fRec46[0] - fRec46[2]) * fSlow53))));
	...
	#define FAUST_FILE_NAME "bells.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("kb0k0status", fHslider0, 0.0f, 0.0f, 1.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("kb0k1status", fHslider3, 0.0f, 0.0f, 1.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("kb1k0status", fHslider4, 0.0f, 0.0f, 1.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("kb1k1status", fHslider5, 0.0f, 0.0f, 1.0f, 1.0f);
	FAUST_ADDHORIZONTALSLIDER("x", fHslider1, 1.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("y", fHslider2, 1.0f, 0.0f, 1.0f, 0.001f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, kb0k0status, "kb0k0status", fHslider0, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(HORIZONTALSLIDER, kb0k1status, "kb0k1status", fHslider3, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(HORIZONTALSLIDER, kb1k0status, "kb1k0status", fHslider4, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(HORIZONTALSLIDER, kb1k1status, "kb1k1status", fHslider5, 0.0f, 0.0f, 1.0f, 1.0f) \
		p(HORIZONTALSLIDER, x, "x", fHslider1, 1.0f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, y, "y", fHslider2, 1.0f, 0.0f, 1.0f, 0.001f) \
...
bells::bells() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void bells::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void bells::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float bells::getParamValue(const std::string& path)
{
