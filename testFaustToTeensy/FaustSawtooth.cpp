...
FaustSawtooth::FaustSawtooth() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void FaustSawtooth::updateImp(void)
{
#if MIDICTRL
...
void FaustSawtooth::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }
...
float FaustSawtooth::getParamValue(const std::string& path)
{
